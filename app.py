...
from ui.components import (
    ...
    render_chapters, render_history_section
)
...
# Main Navigation Tabs (High-Contrast Segmented Styling)
...
with tab_summarize:
    ...
    if 'active_summary' in st.session_state:
        ...
        # Clear & Appealing Export Buttons Section
        st.markdown('<div class="card-box">', unsafe_allow_html=True)
        st.markdown("### 📤 Download & Export Options")
        st.caption("Save your summary in high quality TXT or PDF format for offline reading.")
        st.markdown("<br/>", unsafe_allow_html=True)
